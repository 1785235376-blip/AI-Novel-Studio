...
function mutationPayload(configuration:ModelCenterRuntimeConfiguration):Record<string,unknown>{
 if(configuration.runtime_type==='COMFYUI'){
  return {
   runtime_type:'COMFYUI',
   management:'EXTERNAL',
   executable:configuration.executable||'',
   working_directory:configuration.working_directory||configuration.installation_path||'',
   installation_path:configuration.installation_path||configuration.working_directory||'',
   base_url:configuration.base_url,
   bind_address:configuration.bind_address,
   port:configuration.port,
   health_endpoint:configuration.health_endpoint,
  };
 }
 return {
  ...
  extra_arguments:configuration.extra_arguments??[],
 };
}

function logArrays(payload:{stdout?:string[]|null;stderr?:string[]|null}|null|undefined){
